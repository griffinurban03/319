...
function split_and_matrix(matrix) {
    ...
    for (let element of splitRowByRow) {
        let splitEveryElement = element.split(',');

        //push to matrix
        matrix.push(splitEveryElement);
    }
...
console.log("Griffin Urban");
console.log("griffinu@iastate.edu");
console.log("9/16/2024");
